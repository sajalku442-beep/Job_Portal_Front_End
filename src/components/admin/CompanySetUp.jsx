...
const CompanySetUp = () => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    console.log("inputer from form", input);
  ...
  return (
    <div>
      <Navbar />
      <div className="max-w-xl mx-auto my-10 flex flex-col items-center">
        <form onSubmit={submitHandler}>
          ...
          <div className="w-[90%] flex flex-col sm:grid sm:grid-cols-2 gap-2">
            <div>
          ...
          {loading ? (
            ...
            <Button type="submit" className="w-[90%] my-4">
              Update
            </Button>
          )}
        </form>
